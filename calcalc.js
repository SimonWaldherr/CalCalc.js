...
Object.prototype.appendDay = function (quantity) {
  "use strict";
  var lastday   = this.lastChild.getAttribute('data-datestr').split('.'),
      i         = 0,
      date, datestr, oddweek, oddmonth, newdiv;
...
Object.prototype.prependDay = function (quantity) {
  "use strict";
  var lastday   = this.firstChild.getAttribute('data-datestr').split('.'),
      i         = 0,
      date, datestr, oddweek, oddmonth, newdiv;
